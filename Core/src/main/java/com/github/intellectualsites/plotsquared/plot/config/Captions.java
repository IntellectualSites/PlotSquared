...
public enum Captions implements Caption {
    ...
    FLAG_DESCRIPTION_BLOCK_IGNITION("Set to `false` to disable blocks to ignite within the plot.", "Flags"),
    ...
    FLAG_DESCRIPTION_KELP_GROW("Set to `false` to disable kelp to grow in the plot.", "Flags"),
    ...
    FLAG_DESCRIPTION_MYCEL_GROW("Set to `false` to disable mycelium to grow in the plot.", "Flags"),
    ...
    FLAG_DESCRIPTION_VINE_GROW("Set to `false` to disable vines to grow within the plot.", "Flags"),
