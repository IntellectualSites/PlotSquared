...
import com.plotsquared.bukkit.listener.EntityEventListener1211;
    ...
    public void onEnable() {
        ...
        if (Settings.Enabled_Components.EVENTS) {
            ...
            if ((serverVersion()[1] == 21 && serverVersion()[2] >= 1) || serverVersion()[1] > 21) {
                getServer().getPluginManager().registerEvents(injector().getInstance(EntityEventListener1211.class), this);
            }
