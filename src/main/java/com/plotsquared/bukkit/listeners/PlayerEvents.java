...
public class PlayerEvents extends com.plotsquared.listener.PlotListener implements Listener
{
    ...
    public void onRedstoneEvent(final BlockRedstoneEvent event)
    {
        ...
        switch (block.getType())
        {
            ...
            default:
            {
                ...
                if (!PS.get().isPlotWorld(loc.getWorld())) { return; }
                ...
                if (Settings.REDSTONE_DISABLER_UNOCCUPIED)
                {
                    ...
                    {
                        if (plot.equals(pp.getCurrentPlot())) { return; }
                    }
                    event.setNewCurrent(0);
                    return;
                }
    ...
    public void onProjectileHit(final ProjectileHitEvent event)
    {
        ...
        if (!PS.get().isPlotWorld(loc.getWorld())) { return; }
        final Plot plot = MainUtil.getPlot(loc);
        if (!MainUtil.isPlotArea(loc)) { return; }
        ...
        else if ((shooter instanceof Player))
        {
            ...
            if (plot.isAdded(pp.getUUID())) { return; }
            if (Permissions.hasPermission(pp, C.PERMISSION_PROJECTILE_OTHER)) { return; }
            entity.remove();
        }
    }
    ...
    public void PlayerCommand(final PlayerCommandPreprocessEvent event)
    {
        ...
        pp.getLocation();
        if (!PS.get().isPlotWorld(BukkitUtil.getWorld(player))) { return; }
    ...
    public void onChat(final AsyncPlayerChatEvent event)
    {
        ...
        if (!plotworld.PLOT_CHAT && !plr.getAttribute("chat")) { return; }
    ...
    public void BlockDestroy(final BlockBreakEvent event)
    {
        ...
        if (plot != null)
        {
            ...
            if (!plot.hasOwner())
            {
                if (Permissions.hasPermission(pp, C.PERMISSION_ADMIN_DESTROY_UNOWNED)) { return; }
            ...
            else if (!plot.isAdded(pp.getUUID()))
            {
                ...
                final Block block = event.getBlock();
                if ((destroy != null) && ((HashSet<PlotBlock>) destroy.getValue()).contains(new PlotBlock((short) block.getTypeId(), block.getData()))) { return; }
                if (Permissions.hasPermission(pp, C.PERMISSION_ADMIN_DESTROY_OTHER)) { return; }
        ...
        final PlotPlayer pp = BukkitUtil.getPlayer(player);
        if (Permissions.hasPermission(pp, C.PERMISSION_ADMIN_DESTROY_ROAD)) { return; }
    ...
    public void onFade(final BlockFadeEvent e)
    {
        ...
        if (id == null)
        {
            if (plotworld.TYPE == 2)
            {
                if (ClusterManager.getClusterAbs(BukkitUtil.getLocation(b.getLocation())) != null) { return; }
            }
            e.setCancelled(true);
        }
    }
    ...
    public void onBlockPistonExtend(final BlockPistonExtendEvent event)
    {
        ...
        if (!Settings.PISTON_FALLING_BLOCK_CHECK) { return; }
    ...
    public void onBlockPistonRetract(final BlockPistonRetractEvent event)
    {
        ...
        final String world = loc.getWorld();
        if (!PS.get().isPlotWorld(world)) { return; }
        if ((block.getType() != Material.PISTON_STICKY_BASE) && (block.getType() != Material.PISTON_BASE) && (block.getType() != Material.PISTON_MOVING_PIECE)) { return; }
    ...
    {
        if (!PS.get().isPlotWorld(e.getWorld().getName())) { return; }
    ...
    public void onBucketEmpty(final PlayerBucketEmptyEvent e)
    {
        ...
        if (PS.get().isPlotWorld(loc.getWorld()))
        {
            ...
            if (plot == null)
            {
                if (MainUtil.isPlotAreaAbs(loc))
                {
                    if (Permissions.hasPermission(pp, C.PERMISSION_ADMIN_BUILD_ROAD)) { return; }
                    MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, C.PERMISSION_ADMIN_BUILD_ROAD);
                    e.setCancelled(true);
                }
            }
            else
            {
                ...
                else if (!plot.isAdded(pp.getUUID()))
                {
                    ...
                    if ((use != null) && ((HashSet<PlotBlock>) use.getValue()).contains(new PlotBlock((short) e.getBucket().getId(), (byte) 0))) { return; }
                    if (Permissions.hasPermission(pp, C.PERMISSION_ADMIN_BUILD_OTHER)) { return; }
                    if (MainUtil.isPlotArea(loc))
                    {
                        MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, C.PERMISSION_ADMIN_BUILD_OTHER);
                        e.setCancelled(true);
        ...
        if (PS.get().isPlotWorld(loc.getWorld()))
        {
            ...
            else
            {
                ...
                else if (!plot.isAdded(pp.getUUID()))
                {
                    ...
                    if ((use != null) && ((HashSet<PlotBlock>) use.getValue()).contains(new PlotBlock((short) block.getTypeId(), block.getData()))) { return; }
                    if (Permissions.hasPermission(pp, C.PERMISSION_ADMIN_BUILD_OTHER)) { return; }
                    if (MainUtil.isPlotArea(loc))
                    {
                        MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, C.PERMISSION_ADMIN_BUILD_OTHER);
    ...
    public void onHangingPlace(final HangingPlaceEvent e)
    {
        ...
        if (PS.get().isPlotWorld(loc.getWorld()))
        {
            ...
            else
            {
                ...
                {
                    if (FlagManager.isPlotFlagTrue(plot, C.FLAG_HANGING_PLACE.s())) { return; }
                    if (!Permissions.hasPermission(pp, C.PERMISSION_ADMIN_BUILD_OTHER))
                    {
                        if (MainUtil.isPlotArea(loc))
                        {
        ...
        if (r instanceof Player)
        {
            ...
            if (PS.get().isPlotWorld(l.getWorld()))
            {
                ...
                else
                {
                    ...
                    {
                        if (FlagManager.isPlotFlagTrue(plot, C.FLAG_HANGING_BREAK.s())) { return; }
    ...
    public void onPlayerInteractEntity(final PlayerInteractEntityEvent e)
    {
        ...
        if (PS.get().isPlotWorld(l.getWorld()))
        {
            ...
            if (plot == null)
            {
                if (!MainUtil.isPlotAreaAbs(l)) { return; }
            ...
            else
            {
                ...
                else if (!plot.isAdded(pp.getUUID()))
                {
                    ...
                    if ((entity instanceof Monster) && FlagManager.isPlotFlagTrue(plot, C.FLAG_HOSTILE_INTERACT.s())) { return; }
                    if ((entity instanceof Animals) && FlagManager.isPlotFlagTrue(plot, C.FLAG_ANIMAL_INTERACT.s())) { return; }
                    if ((entity instanceof Tameable) && ((Tameable) entity).isTamed() && FlagManager.isPlotFlagTrue(plot, C.FLAG_TAMED_INTERACT.s())) { return; }
                    if ((entity instanceof Vehicle) && FlagManager.isPlotFlagTrue(plot, C.FLAG_VEHICLE_USE.s())) { return; }
                    if ((entity instanceof Player) && FlagManager.isPlotFlagTrue(plot, C.FLAG_PLAYER_INTERACT.s())) { return; }
        ...
        if (PS.get().isPlotWorld(l.getWorld()))
        {
            ...
            if (d instanceof Player)
            {
                ...
                else
                {
                    ...
                    if (!plot.isAdded(pp.getUUID()))
                    {
                        if (FlagManager.isPlotFlagTrue(plot, "vehicle-break")) { return; }
    ...
    public void onPotionSplash(final PotionSplashEvent event)
    {
        ...
        if (!PS.get().isPlotWorld(l.getWorld())) { return; }
    ...
    public boolean entityDamage(final Location l, final Entity damager, final Entity victim)
    {
        ...
        {
            if (!MainUtil.isPlotAreaAbs(dloc)) { return true; }
            plot = null;
            stub = "road";
        }
        else
        ...
        if (player != null)
        {
            ...
            { // hanging
                if ((plot != null) && ((FlagManager.isPlotFlagTrue(plot, "hanging-break") || plot.isAdded(pp.getUUID())))) { return true; }
            ...
            {
                if ((plot != null) && ((FlagManager.isPlotFlagTrue(plot, "misc-break") || plot.isAdded(pp.getUUID())))) { return true; }
                if (!Permissions.hasPermission(pp, "plots.admin.break." + stub))
                {
                    MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, "plots.admin.break." + stub);
                    return false;
            ...
            { // victim is monster
                if ((plot != null) && ((FlagManager.isPlotFlagTrue(plot, "hostile-attack") || FlagManager.isPlotFlagTrue(plot, "pve") || plot.isAdded(pp.getUUID())))) { return true; }
            ...
            { // victim is tameable
                if ((plot != null) && ((FlagManager.isPlotFlagTrue(plot, "tamed-attack") || FlagManager.isPlotFlagTrue(plot, "pve") || plot.isAdded(pp.getUUID())))) { return true; }
                if (!Permissions.hasPermission(pp, "plots.admin.pve." + stub))
                {
                    MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, "plots.admin.pve." + stub);
                    return false;
            ...
            { // victim is animal
                if ((plot != null) && ((FlagManager.isPlotFlagTrue(plot, "animal-attack") || FlagManager.isPlotFlagTrue(plot, "pve") || plot.isAdded(pp.getUUID())))) { return true; }
                if (!Permissions.hasPermission(pp, "plots.admin.pve." + stub))
                {
                    MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, "plots.admin.pve." + stub);
                    return false;
            ...
            { // victim is something else
                if ((plot != null) && ((FlagManager.isPlotFlagTrue(plot, "pve") || plot.isAdded(pp.getUUID())))) { return true; }
                if (!Permissions.hasPermission(pp, "plots.admin.pve." + stub))
                {
                    MainUtil.sendMessage(pp, C.NO_PERMISSION_EVENT, "plots.admin.pve." + stub);
                    return false;
        ...
        // player is null
        if ((damager instanceof Arrow) && (!(victim instanceof Creature))) { return false; }
        return true;
    }
