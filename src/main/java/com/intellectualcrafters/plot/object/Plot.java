...
public class Plot
{
    ...
    {
        if (!Settings.ENABLE_CLUSTERS) { return null; }
        if (owner == null) { return ClusterManager.getCluster(this); }
    ...
    public HashMap<UUID, Rating> getRatings()
    {
        ...
        if (getSettings().ratings == null) { return map; }
    ...
    public void setHome(final BlockLoc loc)
    {
        ...
        if (((pos == null) && (loc == null)) || ((pos != null) && pos.equals(loc))) { return; }
    ...
    {
        if ((settings != null) && (settings.getAlias().length() > 1)) { return settings.getAlias(); }
