...
public class JSONObject
{
    ...
    public static String valueToString(final Object value) throws JSONException
    {
        ...
        if (value instanceof Collection) { return new JSONArray((Collection<Object>) value).toString(); }
    ...
    public static Object wrap(final Object object)
    {
        try
        {
            ...
            if (object instanceof Collection) { return new JSONArray((Collection<Object>) object); }
